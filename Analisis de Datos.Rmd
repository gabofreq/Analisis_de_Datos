...
ggplot(DATA, aes(x = gender, y = math)) +
  ...
  geom_point(position = "jitter") + theme_bw() +
  labs(title="Diagrama de Cajas", subtitle = paste("Género ~ Matemáticas, Prueba valor p = ",round(res$p.value),5), x = "",y = "Matemáticas") +
  scale_fill_brewer(palette = "Set2",guide=FALSE)
```
